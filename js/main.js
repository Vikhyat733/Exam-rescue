    ...
    <div class="sidebar-logo">
      <div class="logo-mark" style="flex:1;min-width:0">
        ...
        <div style="min-width:0;flex:1">
          <div class="logo-text">Exam Rescue</div>
...
function buildSettings() {
  ...
  panel.innerHTML = `
    ...
    <div class="input-group">
      ...
      <input type="password" class="input-field api-key-input" id="key-openai" placeholder="sk-..." value="${keys.openai || ''}">
    ...
    <div class="input-group">
      ...
      <input type="password" class="input-field api-key-input" id="key-gemini" placeholder="AIza..." value="${keys.gemini || ''}">
